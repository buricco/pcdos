...
NO_ABOVE db	"SMARTDrive: Controlador de Memoria Expandida ausente",13,10,"$"
BAD_ABOVE db	"SMARTDrive: Estado-Memoria Expandida muestra error",13,10,"$"
BAD_AT	db	"SMARTDrive: No se puede utilizar en este ordenador",13,10,"$"
NO_MEM	db	"SMARTDrive: Memoria extendida no disponible",13,10,"$"
ERRMSG1 db	"SMARTDrive: Par metro no v lido",13,10,"$"
ERRMSG2 db	"SMARTDrive: Memoria insuficiente",13,10,"$"
INIT_IO_ERR db	"SMARTDrive: Error de E/S al acceder memoria cach‚",13,10,"$"
NOHARD	db	"SMARTDrive: No hay discos en el sistema",13,10,"$"
BIGTRACK db	"SMARTDrive: Demasiados bytes por pista en disco",13,10,"$"
BADVERMES db	13,10,"SMARTDrive: Versi¢n incorrecta de DOS",13,10,"$"

;
; This is the Int13 header message.
;
HEADERMES db	13,10,"Microsoft SMARTDrive Cach‚ de Disco v2.10",13,10,"$"
...
;
STATMES1  db	"    Tama¤o del cach‚: $"
STATMES1A db	"Kb en Memoria Expandida$"
STATMES1E db	"Kb en Memoria Extendida$"
STATMES2  db	13,10,"    Espacio para $"
STATMES3  db	" pistas de $"
STATMES4  db	" sectores cada uno",13,10,13,10,"$"
ifdef	OMTI
